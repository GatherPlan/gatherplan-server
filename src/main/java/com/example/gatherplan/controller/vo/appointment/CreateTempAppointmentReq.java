...
public class CreateTempAppointmentReq {
    ...
    @Schema(description = "약속 후보 시간", example = "[{\"appointmentCandidateTimeType\":\"MORNING\",\"startTime\":" +
            "\"06:00\",\"endTime\":\"12:00\"},{\"appointmentCandidateTimeType\":\"AFTERNOON\",\"startTime\":\"" +
            "12:00\",\"endTime\":\"18:00\"}]")
